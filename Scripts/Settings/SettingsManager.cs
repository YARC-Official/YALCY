...
internal static class SettingsManager
{
    ...
    private static readonly string SettingsDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "YALCY", "Settings");
    ...
    public static void LoadSettings(MainWindowViewModel mainViewModel)
    {
        if (!Directory.Exists(SettingsDirectory))
        {
            Directory.CreateDirectory(SettingsDirectory);
