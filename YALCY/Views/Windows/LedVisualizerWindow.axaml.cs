...
public partial class LedVisualizerWindow : Window
{
    ...
    private StageKitStatusWindow? _statusWindow;

    private void OnStatusVisualizerButtonClick(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        if (_statusWindow == null)
        {
            _statusWindow = new StageKitStatusWindow();
            _statusWindow.Closed += (s, args) => _statusWindow = null;
            _statusWindow.Show();
        }
        else
        {
